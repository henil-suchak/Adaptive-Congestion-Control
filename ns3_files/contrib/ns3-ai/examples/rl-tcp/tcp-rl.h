 ...
 * and the TcpTimeStepEnv shared-memory RL environment.
 *
 * This class registers "ns3::TcpRlTimeBased" as an NS-3 TypeId so that
 * sim.cc can look it up via TypeId::LookupByNameFailSafe().
 *
 * Pattern mirrors TcpRlInference (inference side) but delegates to
 * TcpTimeStepEnv for training.
 *
 * Based on upstream hust-diangroup/ns3-ai examples/rl-tcp/tcp-rl.h
 */
